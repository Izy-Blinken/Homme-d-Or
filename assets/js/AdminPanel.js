document.addEventListener('DOMContentLoaded', () => {
    ...
    if (productModal) {
        ...
        if (modalCancelBtn) {
            modalCancelBtn.addEventListener('click', () => productModal.classList.remove('show'));
        }
    }
    ...
    if (editProductModal) {
        ...
        if (editModalCancelBtn) {
            editModalCancelBtn.addEventListener('click', () => editProductModal.classList.remove('show'));
        }
    ...
    if (orderModal) {
        ...
        if (orderCloseBtn) {
            orderCloseBtn.addEventListener('click', () => orderModal.classList.remove('show'));
        }

        if (orderDoneBtn) {
            orderDoneBtn.addEventListener('click', () => orderModal.classList.remove('show'));
        }
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (manageCatBtn) {
        manageCatBtn.addEventListener('click', () => catModal.classList.add('show'));
    }

    if (catModalClose) {
        catModalClose.addEventListener('click', () => catModal.classList.remove('show'));
    }
    ...
    if (viewProductModal) {
        ...
        if (viewModalClose) {
            viewModalClose.addEventListener('click', () => viewProductModal.classList.remove('show'));
        }

        if (viewModalDone) {
            viewModalDone.addEventListener('click', () => viewProductModal.classList.remove('show'));
        }
    }
