    ...
    <main>
        <div id="verificationModal" class="verificationModal">
            <div class="verificationModalContent">
                ...
                <form id="verificationForm" action="changePassword.php">
                    ...
                    <button type="submit" class="verifyButton" onclick="window.location.href='../pages/changePassword.php'">Verify Code</button>
