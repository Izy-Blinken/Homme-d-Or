...
function openSignupModal() {
    signupModal.style.display = 'flex'; // change "display: none" to "display: block" ; kumbaga from hidden to visible
    document.body.style.overflow = 'hidden'; // nagllock sa background para hindi magscroll kapag sa modal form nagsscroll
...
function closeSignupModal() {
    signupModal.style.display = 'none'; //opposite ni openSignupModal()
    document.body.style.overflow = 'auto'; // pede na ulit scroll sa bg

    if (signupModal) {
        loginModsignupModalal.classList.remove('show');
