...
function openSignupModal() {
    ...
    document.body.style.overflow = 'hidden'; // nagllock sa background para hindi magscroll kapag sa modal nagsscroll
}

// close signup modal
function closeSignupModal() {
    signupModal.style.display = 'none'; //opposite in openSignupModal()
...
// close kapag cinlick ung close button. Yung closeBtn name dito is yung variable na dineclare sa taas to get the close 
if (closeBtn) {
